    ...
    return (
        <section>
            ...
            <div className="contact-icons">
                <Row>
                    <Col lg={3} md={12}>
                        <a href="https://github.com/Mike2803"><img src="https://img.icons8.com/doodle/100/000000/github--v1.png" alt="github-logo" class="icon" /></a><p class="icon-text">github</p>
                    </Col>

                    <Col lg={3} md={12}>
                        <a href="https://www.linkedin.com/in/michael-coleman-5043b219a/"><img src="https://img.icons8.com/doodle/100/000000/linkedin--v2.png" alt="linkedin-logo" class="icon" /></a><p class="icon-text">linkedin</p>
                    </Col>

                    <Col lg={3} md={12}>
                        <a href="mailto:colemanmichael671@gmail.com"><img src="https://img.icons8.com/doodle/120/000000/new-post.png" alt="mail-logo" /></a><p class="icon-text">email</p>
                    </Col>

                    <Col lg={3} md={12}>
                        <a href={Resume} ><img src="https://img.icons8.com/doodle/120/000000/pdf-2.png" alt="resume" /></a><p class="icon-text">resume</p>
                    </Col>
                </Row>
            </div>
            ...
            <div class="resume-container">
                <Row>
                    ...
                    <Col lg={4} md={12}>
                        ...
                        <p>
                            <span className="school-name">Vanderbilt University</span><br></br>
